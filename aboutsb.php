                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href="#">About</a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="active"><a href="aboutsb.php">uom sb</a></li>
...
.</p>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                    <div class="dividerHeading text-center">
                        <h4><span>Mission statement</span></h4>
                    </div>
                    <p class="lead">IEEE’s core purpose is to foster technological innovation and excellence for the benefit of humanity.</p>
                </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 text-center">
                    <div class="dividerHeading text-center">
                        <h4><span>Vision statement</span></h4>
                    </div>
                    <p class="lead">IEEE will be essential to the global technical community and to technical professionals everywhere, and be universally recognized for the contributions of technology and of technical professionals in improving global conditions.</p>
                </div>
