...
<body class="home" >
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div  class="col-lg-3 col-sm-3 ">
                        <div id="logo">
                            <h1><a href="index.html"><img alt="logo" src="images/ieeeuom.jpg"/></a></h1>
                        </div>
                    </div>
                    <!-- Navigation================================================== -->
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li><a href="#">About</a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a href="aboutsb.php">uom sb</a></li>
                                            <li><a href="aboutieee.php">IEEE</a></li>
                                    ...
                                    <li><a href="#">news</a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li>
                                                <a href="announsments.php">announcements</a>
                                    ...
                                    <li><a href="#">events</a>
                                        <ul class="dropdown-menu">
                                            <li>
                                                <a href="upcommingevents.php">upcomming events</a>
    ...
    <section class="wrapper">
        <div class="slider-wrapper">
            <div class="slider">
                ...
                <div class="slide">
                 ...
                 <!--   <img src="images/ddd.jpg" width="350" height="200" data-position="30,1100" data-in="left" data-out="right" data-delay="700"/>  -->

                    <p class="slide-1" data-position="50,550" data-in="fade" data-out="fade" data-delay="600">welcome to</p>
                    <p class="slide-1" data-position="100,410" data-in="fade" data-out="fade" data-delay="1100">University of Moratuwa </p>
                    <p class="slide-1" data-position="150,500" data-in="fade" data-out="fade" data-delay="1600">Student Branch</p>
             ...
             <!--       <p class="slide-1a" data-position="220,770" data-in="bottom" data-out="bottom" data-delay="2000" data-ease-in="easeOutBounce">SEO Friendly Website</p>
                ...
                <div class="slide">
                 ...
                 <!--   <img src="images/fraction-slider/slider-girl.png" width="600" height="545" data-position="20,400" data-in="right" data-0ut="bottom" data-delay="500"/>  
                   ...
                   <p class="slide-2 " data-position="120,900" data-in="bottom" data-out="top" data-delay="2000">Your-Business</p>
                    ...
                    <p class="slide-2b " data-position="270,750" data-in="top" data-out="bottom" data-delay="1000" data-ease-in="easeOutBounce">advancing technology for humanity</p>
                </div>
                ...
                <!--   <img src="images/ras.jpg" width="300" height="257" data-position="115,1180" data-in="bottom" data-out="bottom" data-delay="400">
        ...
        <div class="container animation-page">
        <div class="row sub_content">
            <div class="col-lg-12 col-md-12 col-sm-12 wow fadeInDown">
                <h1 class="intro text-center">IEEE</h1>
                <h1 class="intro text-center">University of Moratuwa Student Branch </h1>
            </div>
            <div class="col-lg-4 col-sm-4 wow rollIn">
               <div class="animation">
                   <img class="" src="images/ieeeuom.jpg" alt=""/>
                   <p>Animation From   dfghhfghg dfdh rollIn</p>
                   <p>vice chair</p>
                   <p>Animation From rollIn</p>
               </div>
            </div>
            <div class="col-lg-4 col-sm-4 wow bounceInDown">
                <div class="animation">
                    <img class="" src="images/ras.jpg" alt=""/>
                    <p>Animation From bounceInDown</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4 wow lightSpeedIn ">
                <div class="animation">
                    <img class="" src="images/logo.png" alt=""/>
                    <p>Animation From lightSpeedIn </p>
                </div>
            </div>
        </div>
        ...
        <div class="row sub_content">
            <div class="col-lg-4 col-sm-4 wow bounceInLeft">
                <div class="animation">
                    <img class="img-circle" src="images/animation.png" alt=""/>
                    <p>Animation From bounceInLeft</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4 wow pulse ">
                <div class="animation">
                    <img class="img-circle" src="images/animation.png" alt=""/>
                    <p>Animation From pulse</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4 wow bounceInRight ">
                <div class="animation">
                    <img class="img-circle" src="images/animation.png" alt=""/>
                    <p>Animation From bounceInRight</p>
                </div>
            </div>
        </div>
        ...
        <div class="row sub_content">
            <div class="col-lg-4 col-sm-4 wow bounce">
                <div class="animation">
                    <img class="img-circle" src="images/animation.png" alt=""/>
                    <p>Animation From bounce</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4 wow bounceInUp">
                <div class="animation">
                    <img class="img-circle" src="images/animation.png" alt=""/>
                    <p>Animation From bounceInUp</p>
                </div>
            </div>
            <div class="col-lg-4 col-sm-4 wow bounceInDown">
                <div class="animation">
    ...
    <section class="footer_bottom">
        <div class="container">
            <div class="row">
                <div class="col-sm-6">
                    <p class="copyright">&copy; Copyright 2015  | website by <a href="https://www.linkedin.com/in/chamila-maddumage-7b9433bb?trk=nav_responsive_tab_profile">Chamila Maddumage</a>  &  <a href="http://www.jqueryrain.com/">jQuery Rain</a></p>
                </div>

                <div class="col-sm-6 ">
                    <div class="footer_social">
                        <ul class="footbot_social">
                            <li><a  target="_blank" class="fb" href="https://www.facebook.com/chamilaudara.maddumage" data-placement="top" data-toggle="tooltip" title="Facebook"><i class="fa fa-facebook"></i></a></li>
                            <li><a target="_blank" class="twtr" href="https://twitter.com/chamilaudara" data-placement="top" data-toggle="tooltip" title="Twitter"><i class="fa fa-twitter"></i></a></li>
