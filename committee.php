                        ...
                        <div class="navbar navbar-default navbar-static-top" role="navigation">
                            ...
                            <div class="navbar-collapse collapse">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="active"><a href="committee.php">committee</a>
			...
			<div class="container">
                ...
                <div class="row  sub_content">
                    ...
                    <div class="col-lg-3 col-md-3 col-sm-6">
                        <div class="our-team">
                            <div class="pic">
                                <img src="images/cdcd.jpg" alt="profile img">
                            ...
                            <div class="team_prof">
                               <center> <h3 class="post-title">chair</h3>
                                   <h4>nipuna mohotti</h4>
                                   <p class="description">department of ddjsfkds dfusddfi sdfs </p>  </center>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-3 col-sm-6">
